...
class TerraformIntialInitThread implements Runnable {

	private static final Logger log = LoggerFactory.getLogger(TerraformIntialInitThread.class);

	private File tfFilesDir;

	public TerraformIntialInitThread() {

	}

	public TerraformIntialInitThread(File tfFilesDir) {
