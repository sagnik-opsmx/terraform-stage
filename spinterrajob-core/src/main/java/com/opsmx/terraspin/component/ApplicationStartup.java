...
public class ApplicationStartup implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(final ContextRefreshedEvent event) {
		...
		if(StringUtils.equalsIgnoreCase("plan", currentComponent)) {
			...
			planComponent.onApplicationEvent();
		}

		if(StringUtils.equalsIgnoreCase("apply", currentComponent)) {
			ApplyComponent applyComponent = new ApplyComponent();
			applyComponent.onApplicationEvent();
		}
